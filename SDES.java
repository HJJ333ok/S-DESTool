...
public class SDES {
    ...
    public static String encrypt(String plaintext, String key) { //加密主体
        // 生成 key1 和 key2
        String keyP10 = substitue(key, P10);
        String keyLeft = move(keyP10.substring(0, 5), 1);
        String keyRight = move(keyP10.substring(5, 10), 1);
        String key1 = substitue(keyLeft + keyRight, P8);
        keyLeft = move(keyLeft, 2);
        keyRight = move(keyRight, 2);
        String key2 = substitue(keyLeft + keyRight, P8);
